...
function InfoApplication() {
    ...
    // location : dernière position connue
    ...
    // pauseCounter : permet d'enclencher l'état de pause si le compteur atteint pauseTrigger (nombre de fois que l'on détecte une vitesse très faible ou 
